...
const RightSidebar = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      technologies: ["React.js", "Node.js", "Express.js", "Cors", "Puppeteer"],
    },
    {
    ...
    <div className=" font-['Inconsolata']">
      <div className="flex flex-col items-center">
        ...
        <div className=" p-6 md:p-10 mb-10 md:mb-6">
          ...
          <p className="flex text-lg md:text-xl font-medium">
            <a
              href="https://drive.google.com/file/d/12u88lAik5S4_NPzGMC9zgGQn3-RSAxdI/view?usp=sharing"
              target="_blank"
              rel="noopener noreferrer"
              className="flex text-lg md:text-xl font-medium hover:text-[#0093e9] font-['Inconsolata']"
            >
        ...
        {/* Experience Section */}
        <div className="experience  p-6 md:p-10 mb-10 md:mb-4">
          ...
          {experiences.map((exp, index) => (
            <div key={index} className="experience-item mb-6">
              <p className="title text-2xl font-semibold">
                <span className="hover:text-[#0093e9]">{exp.title}</span>
              </p>
          ...
          {projects.map((project, index) => (
            <div key={index} className="project mb-6">
              <p className="text-2xl font-semibold">
                <span className="hover:text-[#0093e9]">{project.title}</span>
              </p>
              <div className="work-details">
              ...
              <div className=" project-links mb-2 flex flex-wrap gap-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex border hover:text-[#0093e9]  px-2 py-1 rounded-md"
                >
                  Live Link
                    <GoArrowUpRight />
                </a>
